			...
			<div class="box_miMyPr1">
				...
				<img src="/images/fsitter/h4.svg" class="svgImg3">
					 <div class="form-group m_font" id="MyPro1">
					   	<input type="text" class="form-control m_font" id="loc2" placeholder="서울시 마포구 합정동">
						<label class="control-label m_font" for="loc">펫시터&emsp;</label>
					 
					   	<input type="text" class="form-control m_font" id="sitterName2" placeholder="다나카">
					 	<label for="sitter_name m_font">님</label>
					 	<br>
