			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-check">
						<input class="form-check-input" type="radio" name="petSize" id="1"> <label
							class="form-check-label" for="1"> <span class="m_font">소형 : 7키로 미만(고양이 포함)</span></label><br>
						<input class="form-check-input" type="radio" name="petSize" id="2"> <label
							class="form-check-label" for="2"> <span class="m_font">중형 : 7 ~ 14.9키로</span></label><br>
						<input class="form-check-input" type="radio" name="petSize" id="3"> <label
					...
					<div class="form-check">
						<input class="form-check-input" type="radio" name="smoking"
							...
							for="smoking1"><span class="m_font"> 흡연 (예) </span> </label> 
						<input class="form-check-input" type="radio" name="smoking"
							id="smoking2"> <label class="form-check-label"
							for="smoking2"><span class="m_font"> 흡연 (아니요) </span> </label>
