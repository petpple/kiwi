...
<link rel="stylesheet" href="/css/member/memberMainPage.css">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-2" id="info">
					<c:import url="http://localhost:8091/member/memberSide"></c:import>
				</div>
				<div class="col-md-7">
					<div class="IMG1">
				...
				<div class="col-md-3">
					<div id="test">
						<c:import url="memberCal.jsp"></c:import>
					</div>
				</div>
			</div>
		</div>
